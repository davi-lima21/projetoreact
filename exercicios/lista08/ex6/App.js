...
export default class App extends React.Component {
  ...
  enviarDados() {
    ...
    if (nome == "" || sobrenome == "" || idade == "") {
      ...
      this.setState({ clientes: [...this.state.clientes, { nome, sobrenome, idade }] });
    }
  }

  excluirCliente() {
    this.setState({ clientes: this.state.clientes ? this.state.clientes.slice(0, -1) : [] })
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.titulo1}>Cadastrar clientes</Text>
          ...
          <View style={styles.containerButtons}>
            ...
            <View style={styles.buttons}>
              <Button color='#ff0000' title='Excluir' onPress={() => this.excluirCliente()}></Button>
            </View>
          </View>
